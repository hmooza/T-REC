                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="form-horizontal">
                                <label class="control-label col-sm-2 col-md-1" for="txtUsername">SET Name:</label>KD
                                <div class="col-sm-3 col-md-3">
                                    <asp:TextBox ID="inputUsername" runat="server" type="text" class="form-control" placeholder="input SET Name" ValidationGroup="updatedata"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="input username" ForeColor="Red"
                                        ControlToValidate="inputUsername" ValidationGroup="updatedata"></asp:RequiredFieldValidator>
                                </div>

                                <div class="col-md-2 form-group">
                                    <asp:Button ID="Button2" runat="server" Text="Create New SET" class="btn btn-primary" CausesValidation="false" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-info" id="div1" runat="server">
                        <div class="panel-heading">
                            <h3 class="panel-title">SET Detail -
                                <asp:Label ID="lblSetName" runat="server" Text="@Set Name"></asp:Label></h3>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="col-sm-2 col-md-2">
                                            ประเภท:
                                            <asp:DropDownList ID="ddlType" runat="server" type="text" class="form-control" ValidationGroup=""></asp:DropDownList>
                                        </div>

                                        <div class="col-sm-2 col-md-2">
                                            ชนิด:
                                            <asp:DropDownList ID="ddlCat" runat="server" type="text" class="form-control" ValidationGroup=""></asp:DropDownList>
                                        </div>

                                        <div class="col-sm-2 col-md-2">
                                            รายการอุปกรณ์:
                                            <asp:DropDownList ID="ddlName" runat="server" type="text" class="form-control" ValidationGroup=""></asp:DropDownList>
                                        </div>

                                        <div class="col-md-2 form-group" style="padding-top: 20px; padding-left: 20px;">
                                            <asp:Button ID="Button1" runat="server" Text="+" class="btn btn-primary" CausesValidation="false" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <asp:GridView ID="grid_Detail" runat="server" Width="100%" PageSize="10" AllowPaging="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="ราคาเช่า" />
                                        <asp:BoundField HeaderText="Last Update" DataField="UpdatedDate" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundField>
                                        <asp:BoundField HeaderText="Update By" DataField="UpdatedBy"></asp:BoundField>
                                    </Columns>
                                    <PagerStyle CssClass="pagination-ys" HorizontalAlign="Center"></PagerStyle>
                                    ...
                                    <div class="col-sm-4 col-md-4" style="padding-top: 20px;">
                                        <div>
                                            <div class="input-group">
                                                ...
                                                <asp:TextBox ID="txtCost" runat="server" CssClass="form-control  text-right"></asp:TextBox>
                                                <span class="input-group-addon" id="Span10">บาท</span>
                                            </div>
                                        </div>
